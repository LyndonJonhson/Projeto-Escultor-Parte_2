...
public:
     ...
     * @param x é o local no eixo x que o voxel será ativado.
     * @param y é o local no eixo y que o voxel será ativado.
     * @param z é o local no eixo z que o voxel será ativado.
     */
    void putVoxel(int x, int y, int z);

    /**
     * @brief Apaga um Voxel no local (x, y, z).
     * @param x é o local no eixo x que o voxel será desativado.
     * @param y é o local no eixo y que o voxel será desativado.
     * @param z é o local no eixo z que o voxel será desativado.
     */
